...
namespace mime_types {
	...
	constexpr std::string_view get_mime_type_sv(const std::string_view& ext) {
	...
	constexpr std::string_view get_mime_type(const char* ext) { return get_mime_type_sv(std::string_view(ext)); }
}  // namespace mime_types