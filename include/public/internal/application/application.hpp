...
#include <internal/exceptions/socket_not_created.hpp>
#include <internal/exceptions/unable_to_bind_to_socket.hpp>
#include <internal/exceptions/unable_to_retrieve_address.hpp>
...
namespace webframe::core {
	...
	private:
		...
		utils::SyncStream performancer;
		utils::SyncStream logger;
		utils::SyncStream warn;
		utils::SyncStream errors;
...
namespace webframe::core {
	...
	application& application::set_performancer(std::ostream* _performancer) {
		performancer.set(_performancer);
		return *this;
	}
